...
public class playActionDisplay extends JFrame {
    ...
    public void createGUI() {
        ...
        subPanel3.setBorder(BorderFactory.createTitledBorder("Team 1"));
        ...
        //table4.setGridColor(Color.gray);
    ...
    //take off grids
    //make it stop loading a new window all the time
    //adjust bottom two tables to scroll

    //figure out why we have to click
